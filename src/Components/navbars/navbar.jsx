...
// This component represents the navigation bar at the top of the app, with links to create new flashcards and view existing ones
      ...
      <nav className="mx-7 sm:mx-12 md:mx-20 lg:mx-24 mt-10">
        ...
        <ul className="flex border-b-gray-500 mx-1 text-sm text-gray-500">
          <li className="font-semibold  hover:text-red-600 border-red-500 cursor-pointer">
            <Link
              className="focus:text-red-600 py-2 focus:border-b-2 focus:border-red-600"
              to="/"
            >
              Create New
            </Link>
          ...
          <li className="font-semibold mx-8 hover:font-semibold hover:text-red-600 border-red-600 cursor-pointer">
            <Link
              className="focus:text-red-600 focus:border-b-2 py-2 focus:border-red-600"
              to="/myflashcards"
            >
              My Flashcards
            </Link>
